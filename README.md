...
Demand for resale flats since the end of the Circuit Breaker has pushed prices and sales to new highs. According to the HDB Price Index in Q2 2021, resale flat prices climbed 3% from Q1 2021, growing for the fifth consecutive quarter since Q2 2020. Prices were also 11% higher compared to a year ago. 

As data scientists, we want to understand the factors driving the price of resale flats and provide predicted sale price. Most property portals such as SRX, PropertyGuru, and other property agencies usually suggest that location of a property and proximity to amenities such as MRT stations, Primary School, and shopping centers, play important variable in determining prices. In this project the models will evaluate these as feature impoortance.
...
The evaluation metrics will be overfitting/underfitting of RMSE less than 2% between train and test data.
